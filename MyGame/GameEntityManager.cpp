...
GameEntityManager::GameEntityManager(CIndieLib* master, SpriteCordinateMapper* spriteCordinates, AnimationMapper* animationMapper, const char* resourcePath, float* deltaTime) :
